...
Route::middleware('auth:api')->group( function () {
    Route::resource('categorys', 'App\Http\Controllers\Api\CategoryController', ['except' => ['create', 'show', 'edit']]);
    Route::resource('products', 'App\Http\Controllers\Api\ProductController', ['except' => ['create', 'index', 'edit']]);
});
